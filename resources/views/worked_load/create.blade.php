...
<div class="container">
    <div class="page-inner">
        <div class="page-header">
            <h3 class="fw-bold mb-3">Add New Deal</h3>
                        ...
                        <form method="POST" action="{{ route('deals.store') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="value" id="value" class="form-control" placeholder="Enter value" value="{{ old('value') }}" step="0.01" min="0" required>
                                </div>
                            </div>
